  ...
  return (
    <div className="p-2 space-y-4">
      <div className="flex flex-col gap-1">
        <h4 className="text-xl font-semibold">{eventInfo.event.title}</h4>
        <span className={`${eventInfo.event.extendedProps.type === "due" ? "bg-red-500" : "bg-green-500"} text-xs text-white font-medium rounded-full px-2 py-1`}>{eventInfo.event.extendedProps.type === "due" ? "Due Date" : "Start Date"}</span>
      </div>
